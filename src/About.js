            ...
            <div>
                <Card>
                    ...
                    <div className="box">
                     ...
                     <a href="https://www.kaggle.com/fabiendaniel/predicting-flight-delays-tutorial/notebook" target="_blank" rel="noopener noreferrer" className="link"> Kaggle's Dataset</a>.<br></br>
